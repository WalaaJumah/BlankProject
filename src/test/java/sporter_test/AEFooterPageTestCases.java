...
//        webDriver.navigate().to(environment);
    ...
    @Test(groups = {"Footer Section","Smoke Testing Result","4. Low Severity"},description = " Footer Section- Verify the Join Our NEWSLETTER section that appears in the footer section is displayed correctly", priority = 2)
    ...
    @Test(groups = {"Footer Section","Smoke Testing Result","3. Medium Severity"},description = " Footer Section- Make sure the user(Male) can join sporter NEWSLETTER correctly", priority = 3)
    ...
    @Test(groups = {"Footer Section","Smoke Testing Result","3. Medium Severity"},description = " Footer Section- Make sure the user(Female) can join sporter NEWSLETTER correctly", priority = 4)
