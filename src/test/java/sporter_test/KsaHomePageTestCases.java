...
public class KsaHomePageTestCases extends BaseTest {
    ...
    @Test(description = "Make sure clicking on the Sports Supplements category redirect the user to correct URL ", priority = 42)
    ...
    @Test(description = "Make sure clicking on the Healthy Food category redirect the user to correct URL ", priority = 43)
    ...
    @Test(description = "Make sure clicking on the Vitamins And Health category  redirect the user to correct URL ", priority = 44)
    ...
    @Test(description = "Make sure clicking on the Sportswear & Accessories category redirect the user to correct URL ", priority = 45)
    ...
    @Test(description ="Make sure clicking on the products appearing in the Top Selling Stacks section redirect the user to the correct URL", priority = 46)
    ...
    @Test(description ="Make sure clicking on the products appearing in the Top Sellers section redirect the user to the correct URL", priority = 47)
    ...
    @Test(description ="Make sure clicking on the products appearing in the New Arrivals section redirect the user to the correct URL", priority = 48)
    ...
    @Test(description = "Make sure the Ability to click on phone button that appears in the Got A Question section correctly ", priority = 49)
