...
//        qatarHomePage.webDriver=this.webDriver;
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure clicking on the banners inside the rotating slider section works correctly", priority = 3)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure clicking on the first and second side banners works correctly", priority = 4)
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure clicking on the HomePage Horizontal Banner works correctly", priority = 5)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure clicking on the banners appearing under shop by category banners works correctly", priority = 8)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure the Top Selling Stacks section is displayed ", priority = 9)
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure the Top Sellers section is displayed ", priority = 10)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"3. Medium Severity","Home Page","Smoke Testing Result"},description = "Qatar HomePage- Make sure that all links appear correctly in the Top Sellers section ", priority = 11)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure the Trending On Sporter section is displayed ", priority = 18)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","2. High Severity"},description = "Qatar HomePage- Make sure the New Arrivals section is displayed ", priority = 21)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Smoke Testing Result","1. Critical Severity"},description = "Qatar HomePage- Make sure clicking on email button from the Got A Question section works correctly ", priority = 30)
