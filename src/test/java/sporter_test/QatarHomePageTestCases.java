...
//        qatarHomePage.webDriver=this.webDriver;
    ...
    @Test( groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure the next and previous buttons appearing in the HomePage rotating slider section are displayed ", priority = 2)
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure clicking on the banners inside the rotating slider section works correctly", priority = 3)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure clicking on the first and second side banners works correctly", priority = 4)
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure clicking on the HomePage Horizontal Banner works correctly", priority = 5)
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure the Shop By Category section is displayed ", priority = 6)
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure the main options in the Mega Menu are retrieved correctly", priority = 7)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure clicking on the banners appearing under shop by category banners works correctly", priority = 8)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure the Top Selling Stacks section is displayed ", priority = 9)
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure the Top Sellers section is displayed ", priority = 10)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"1.3 Medium Severity","2.01 Home Page","All Smoke Testing Result"},description = "Qatar HomePage- Make sure that all links appear correctly in the Top Sellers section ", priority = 11)
...
//        Assert.assertTrue(qatarHomePage.getAllLink().isDisplayed());
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on ALL tab from the Top Seller Section works correctly ", priority = 12)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sport Supplements tab from the Top Seller Section works correctly ", priority = 13)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food tab from the Top Seller Section works correctly  ", priority = 14)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health tab from the Top Seller Section works correctly", priority = 15)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear And Accessories from the Top Seller Section works correctly ", priority = 16)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure that previous and next buttons in the Top Seller Section work correctly ", priority = 17)
    ...
    @Test(groups = {"2.01 Home Page","All Smoke Testing Result","1.2 High Severity"},description = "Qatar HomePage- Make sure the Trending On Sporter section is displayed ", priority = 18)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure the next button appearing in the Trending On Sporter section works Correctly ", priority = 19)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure that all tabs appear correctly in the New Arrivals section ", priority = 22)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the ALL tab from the New Arrivals Section works correctly", priority = 23)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sport Supplements tab from the New Arrivals Section works correctly ", priority = 24)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food tab from the New Arrivals Section works correctly", priority = 25)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health tab from the New Arrivals Section works correctly", priority = 26)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear And Accessories tab from the New Arrivals Section works correctly ", priority = 27)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure that previous and next button appearing in the New Arrival section works correctly ", priority = 28)
...
//    }
    ...
    @Test(groups = {"2.01 Home Page","1.3 Medium Severity"},description = "Qatar HomePage- Make sure the Got A Question section is displayed ", priority = 29)
...
//        qatarHomePage.navigate();
    ...
    public void verifyAbilityToClickOnEmailBtnInGotQuestionSectionCorrectly() {
        ...
        DataHelperAndWait.waitForUrlContains(qatarHomePage.contactUsUrl,webDriver,20);
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(qatarHomePage.contactUsUrl), "The system redirect the user to wrong URL " + webDriver.getCurrentUrl());
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Sports Supplements category from HomePage works correctly ", priority = 31)
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food category from HomePage works correctly ", priority = 32)
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health category from HomePage works correctly", priority = 33)
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear & Accessories category from HomePage works correctly", priority = 34)
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the products appearing in the Top Selling Stacks section works correctly", priority = 35)
...
//        qatarHomePage.verifyTheDisplayedPageDoesNotHaveErrors();
    ...
    @Test(groups = {"2.01 Home Page","1.1 Critical Severity"},description = "Qatar HomePage- Make sure clicking on the products appearing in the Top Sellers section redirect the user to the correct URL", priority = 36)
    ...
    @Test(groups = {"2.01 Home Page","1.2 High Severity"},description = "Qatar HomePage- Make sure clicking on phone button from the Got A Question section works correctly ", priority = 38)
