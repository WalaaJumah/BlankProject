...
public class UAETamaraPaymentMethodTestCases extends TamaraPaymentMethodTestCases {
    ...
    public void verifyTamaraPaymentMethodMethodCorrectlyForGuestUser() throws Exception {
        ...
        @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "{{CountryName}}:GuestUser- Make sure the Installments Amounts In Tamara Page Are Matched With The Grand Total", priority = 2)
