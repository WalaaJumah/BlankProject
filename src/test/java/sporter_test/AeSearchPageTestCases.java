...
public class AeSearchPageTestCases extends BaseTest {
    ...
    @Test(groups = {"Search","Smoke Testing Result","1. Critical Severity"},description = "Verify clicking on the search button will redirect the user to the search screen", priority = 1)
    ...
    @Test(groups = {"Search","Smoke Testing Result","3. Medium Severity"},description = "Search Page- Make sure all menus appearing in the Mega Menu are displayed correctly when hovering on them from Search page", priority = 4)
    ...
    @Test(groups = {"Search","Smoke Testing Result","2. High Severity"},description = "Search Page- Make sure the ability to access all products appearing below the products section in the All Page", priority = 6)
