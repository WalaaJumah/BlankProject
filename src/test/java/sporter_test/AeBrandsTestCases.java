 ...
 * @classgroups = {"2.13 Brands Page", "1.3 Medium Severity"},description This class make sure all pages related to the Brand pages from search screen works fine
 */
...
public class AeBrandsTestCases extends BaseTest {
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Jym supplementJym supplement brand correctly", priority =2 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Blender Bottle brand correctly", priority =3 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the V3 Apparel brand correctly", priority =4 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Swanson Vitamins brand correctly", priority =7 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Efx Sports brand correctly", priority =8 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Planetary Herbals brand correctly", priority =9 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the puma brand correctly", priority =11 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Women Best brand correctly", priority =12 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Health Aid brand correctly", priority =13 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Rainbow Light brand correctly", priority =15 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Ghost brand correctly", priority =17 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Full Green brand correctly", priority =19 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Life Extension brand correctly", priority =21 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Sporter brand correctly", priority =22 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Titin Force brand correctly", priority =24 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Sotru brand correctly", priority =25 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Nairn’s brand correctly", priority =28 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Chike Nutrition brand correctly", priority =30 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Fitmark brand correctly", priority =31 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Quest Nutrition brand correctly", priority =32 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Xtend brand correctly", priority =33 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Cellucor brand correctly", priority =34 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Bpi Sports brand correctly", priority =35 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Animal Nutrition brand correctly", priority =36 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Universal Nutrition brand correctly", priority =38 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Flahavan's brand correctly", priority =39 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Bobs Red Mill brand correctly", priority =40 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Nu Hair brand correctly", priority =41 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to theShen Min brand correctly", priority =42 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Natrol brand correctly", priority =43 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Pandomar brand correctly", priority =44 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Organic Larder brand correctly", priority =45 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Russian Bear brand correctly", priority =46 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Performa brand correctly", priority =47 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Webber Naturals brand correctly", priority =48 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Prolab brand correctly", priority =49 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Jobedu brand correctly", priority =50 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Windmill brand correctly", priority =51 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Orgain brand correctly", priority =52 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Optimum Nutrition brand correctly", priority =53 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Hunter Foods brand correctly", priority =55 )
    ...
    @Test(groups = {"2.13 Brands Page", "1.3 Medium Severity"},description = "Make sure the ability to access all pages related to the Nutrex Research brand correctly", priority =56 )
