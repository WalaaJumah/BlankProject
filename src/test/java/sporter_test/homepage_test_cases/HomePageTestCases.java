...
//    }
    ...
    @Test(groups = { "2. High Severity"}, description = "HomePage- Make sure clicking on the Categories tabs appearing in the New Arrivals section are working correctly", priority = 19)
