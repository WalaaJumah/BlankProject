...
//        this.verifyThePaginationControlInSportsCategoryPageWorksCorrectly();
    ...
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Mens Apparel Category Page ", priority = 227)
    ...
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Women's Apparel Category Page ", priority = 228)
    public void verifyAbilityToAccessAllPagesInsideWomenApparelCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Yoga Apparel Category Page ", priority = 229)
    public void verifyAbilityToAccessAllPagesInsideYogaApparelCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Swimming Category Page ", priority = 230)
    public void verifyAbilityToAccessAllPagesInsideSwimmingCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Mma Category Page ", priority = 231)
    public void verifyAbilityToAccessAllPagesInsideMmaCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Cricket Category Page ", priority = 232)
    public void verifyAbilityToAccessAllPagesInsideCricketCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Toys And Games Category Page ", priority = 233)
    public void verifyAbilityToAccessAllPagesInsideToysAndGamesCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Wearable Tech Category Page ", priority = 234)
    public void verifyAbilityToAccessAllPagesInsideWearableTechCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Personal Care Category Page ", priority = 235)
    public void verifyAbilityToAccessAllPagesInsidePersonalCareCategoryPageCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Men Category From Sports Category Page  ", priority = 236)
    public void verifyAbilityToAccessAllPagesInsideMenCategoryFromSportsCategoryPageWorksCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Women Category From Sports Category Page  ", priority = 237)
    public void verifyAbilityToAccessAllPagesInsideWomenCategoryFromSportsCategoryPageWorksCorrectly(){
        ...
        DataHelperAndWait.accessAllPagesInsideTheProductsListPage(numberOfProductInTheList,aeSportSupplementsCategoryPage.getNextPageBtn(),webDriver);}
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Sports Tech Category From Sports Category Page  ", priority = 238)
    ...
    @Test(groups = {"Sports Category","All Smoke Testing Result","3. Medium Severity"},description = "Sports Category- Make Sure the ability to access all pages inside Kids Category From Sports Category Page  ", priority = 239)
