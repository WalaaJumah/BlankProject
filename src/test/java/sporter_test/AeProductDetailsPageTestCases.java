...
//        assertTrue(verifyTitle, "Page Not Found Is Displayed");
    ...
    @Test(description = "Make sure that the customer can add the same product more than once by clicking on the Add To Product button in each time ", priority = 14)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), wheyProteinOptionInSportSupplementsMenuUrl);
    ...
    public void verifyPreviousReviewPageBtnAppearsInReviewsSectionWorksCorrectly() {
        ...
        DataHelperAndWait.waitForUrlContains("p=1",webDriver,5);
