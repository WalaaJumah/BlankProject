...
public class AeHealthyFoodCategoryTestCases extends BaseTest {
    ...
    @Test(groups = {"Healthy Food Category","Smoke Testing Result","1. Critical Severity"},description = "Healthy Food Category- Make sure clicking on the Healthy Food Category Appears In MegaMenu Redirect User To CorrectURL", priority = 2)
    ...
    @Test(groups = {"Healthy Food Category","Smoke Testing Result","1. Critical Severity"},description = "Healthy Food Category- Make sure clicking on the Healthy Food Category from ShopBy Menu Redirect User To CorrectURL", priority = 3)
    ...
    @Test(groups = {"Healthy Food Category","Smoke Testing Result","1. Critical Severity"},description = "Healthy Food Category- Make sure clicking on the Healthy Food Category from HomePage Redirect User To CorrectURL", priority =4)
...
//    //There's a bug here
    ...
    @Test(groups = {"Healthy Food Category","Smoke Testing Result","3. Medium Severity"},description = "Healthy Food Category- Make Sure the ability to access all pages inside Healthy Food Category Page  ", priority = 29)
