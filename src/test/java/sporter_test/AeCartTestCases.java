...
//            CloseInitialDialog();          }
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure to view the cart from PDP after adding  product to it", priority = 2)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure that the product counter that appears in the cart page works correctly", priority = 3)
...
//        aeCartPage.clickOnRemoveItem();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that the Free Gift is removed from the cart when you remove the product", priority = 4)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Verify ability to remove the product from the cart successfully", priority = 5)
...
//        Assert.assertTrue(aeCartPage.getNoItemInCartLabel().isDisplayed());
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that Here Link appear after clearing the items from the Cart works successfully", priority = 6)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure that the product counter that appears in the cart page counts the free gift correctly", priority = 7)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure to view the cart after adding more than quantity for the same product", priority = 8)
...
//    aeCartPage.clickOnRemoveItem();}
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure to view the cart after adding more than products to it", priority = 9)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Adding a config to the cart more than one with different simple in each time", priority = 10)
...
//
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure ability to add bundle to the Cart", priority = 11)
...
//        aeCartPage.clickOnRemoveItem();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the The requested qty is not available message appear when the product becomes OOS", priority = 12)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Verify that the ContinueShoppingBtn works correctly when displaying The requested qty is not available message", priority = 13)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Verify ability to increase the product quantity from Cart page from the Cart Page works successfully", priority = 14)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Verify ability to Decrease the product quantity from Cart page from the Cart Page works successfully", priority = 15)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Verify ability to display the product from the Cart Page works successfully", priority = 16)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that the Free Gift is added correctly to the Cart", priority = 17)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that the Free Gift does not have a price", priority = 18)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that all payment methods are appear correctly in the Cart page", priority = 19)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure that the Proceed to checkout button appears in the cart page works correctly", priority = 20)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.1 Critical Severity"},description = " Cart Page- Make sure that the order total calculation in the cart page works correctly", priority = 21)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Make sure that the customer can view the cart using Cart Icon", priority = 22)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure that the counter-number appears in the cart pop up works correctly", priority = 23)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure that the  close icon appears in the cart pop-up works correctly", priority = 24)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that the system does not apply invalid coupon code", priority = 25)
...
////        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure inability to apply coupon code without filling the code", priority = 26)
...
////        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Make sure that the free gift is not calculated in the cart price", priority = 27)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Make sure the tax calculate correctly", priority = 28)
...
//        aeCartPage.clickOnRemoveItem();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Verify that the search button works correctly from the Cart Page", priority = 29)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","1.3 Medium Severity"},description = " Cart Page- Make sure that the product price is changed when you change the quantity from the Cart Page", priority = 30)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","1.4 Low Severity"},description = " Cart Page- Make sure that Make sure that complete your order, to get 100% GENUINE PRODUCTS and SUPER DELIVERY WITHIN 2 WORKING DAYS label appears in the Cart Page", priority = 31)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","1.4 Low Severity"},description = " Cart Page- Make sure that the Expected delivery date field in the cart page retrieves data", priority = 32)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure that the item-count appears in the cart pop up works correctly", priority = 33)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","1.3 Medium Severity"},description = " Cart Page- Make sure that My Shopping Cart title appears in the Cart Page", priority = 34)
...
//    }
//    @Test(groups = {"Cart Page","1.3 Medium Severity"},description = " Cart Page- Make sure that the system cancel the coupon code correctly", priority = 35,enabled = false)
...
//        aeCartPage.removeProductFromCart();
//    }
//    @Test(groups = {"Cart Page","1.3 Medium Severity"},description = " Cart Page- Verify that The requested qty is not available message appear when the product becomes OOS in Cart Page successfully", priority = 36,enabled = false)
...
//    }
//    @Test(groups = {"Cart Page","1.2 High Severity"},description = " Cart Page- Make sure that the customer can't add more than 2 Qty of the same product when switching to Jordan Store from Cart Page", priority = 37,enabled = false)
...
//    }
//    @Test(groups = {"Cart Page","1.3 Medium Severity"},description = " Cart Page- Make sure that the system will empty the cart after switching the country", priority = 38,enabled = false)
...
//        Assert.assertTrue(aeCartPage.getNoItemInCartLabel().isDisplayed());
//    }
//    @Test(groups = {"Cart Page","1.2 High Severity"},description = " Cart Page- Make sure that the free coupon code working fine", priority = 39,enabled = false)
...
//        Assert.assertTrue(aeCartPage.getFreeFromSporterSection().isDisplayed());
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Make sure ability to add a bundle to the cart with all bundle options", priority = 40)
...
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the ShopBy Menu Is Displayed When Hovering On It From Cart Page", priority = 41)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the Sport Supplements Menu Is Displayed When Hovering On It From Cart Page", priority = 42)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the Vitamins And Health Menu Is Displayed When Hovering On It From Cart Page", priority = 43)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the Healthy Food Menu Is Displayed When Hovering On It From Cart Page", priority = 44)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Verify that the Sports Menu Is Displayed When Hovering On It From Cart Page", priority = 45)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.3 Medium Severity"},description = " Cart Page- Verify that the account Profile icon works correctly in the Cart Page", priority = 46)
...
//    }
//
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.4 Low Severity"},description = " Cart Page- Make sure ability to navigate to the home page by clicking on the Sporter logo from the Cart Page ", priority = 47)
...
//    }
//    @Test(groups = {"Cart Page","All Smoke Testing Result","1.2 High Severity"},description = " Cart Page- Make sure that the ability to switch to Arabic version from the cart page correctly", priority = 48)
