...
//        qatarHomePage.webDriver=this.webDriver;
    ...
    @Test( groups = {"Home Page","Low Severity"},description = "Qatar HomePage- Make sure the next and previous buttons appearing in the HomePage rotating slider section are displayed ", priority = 2)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure the Shop By Category section is displayed ", priority = 6)
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure the main options in the Mega Menu are retrieved correctly", priority = 7)
...
//        Assert.assertTrue(qatarHomePage.getAllLink().isDisplayed());
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on ALL tab from the Top Seller Section works correctly ", priority = 12)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sport Supplements tab from the Top Seller Section works correctly ", priority = 13)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food tab from the Top Seller Section works correctly  ", priority = 14)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health tab from the Top Seller Section works correctly", priority = 15)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear And Accessories from the Top Seller Section works correctly ", priority = 16)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure that previous and next buttons in the Top Seller Section work correctly ", priority = 17)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure the next button appearing in the Trending On Sporter section works Correctly ", priority = 19)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure the previous button appearing in the Trending On Sporter section works Correctly ", priority = 20)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure that all tabs appear correctly in the New Arrivals section ", priority = 22)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the ALL tab from the New Arrivals Section works correctly", priority = 23)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sport Supplements tab from the New Arrivals Section works correctly ", priority = 24)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food tab from the New Arrivals Section works correctly", priority = 25)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health tab from the New Arrivals Section works correctly", priority = 26)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear And Accessories tab from the New Arrivals Section works correctly ", priority = 27)
...
//        qatarHomePage.navigate();
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure that previous and next button appearing in the New Arrival section works correctly ", priority = 28)
...
//    }
    ...
    @Test(groups = {"Home Page","Medium Severity"},description = "Qatar HomePage- Make sure the Got A Question section is displayed ", priority = 29)
...
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(qatarHomePage.contactUsUrl), "The system redirect the user to wrong URL " + webDriver.getCurrentUrl());
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Sports Supplements category from HomePage works correctly ", priority = 31)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Healthy Food category from HomePage works correctly ", priority = 32)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Vitamins And Health category from HomePage works correctly", priority = 33)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the Sportswear & Accessories category from HomePage works correctly", priority = 34)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the products appearing in the Top Selling Stacks section works correctly", priority = 35)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the products appearing in the Top Sellers section redirect the user to the correct URL", priority = 36)
    ...
    @Test(groups = {"Home Page","Critical Severity"},description = "Qatar HomePage- Make sure clicking on the products appearing in the New Arrivals section redirect the user to the correct URL", priority = 37)
    ...
    @Test(groups = {"Home Page","High Severity"},description = "Qatar HomePage- Make sure clicking on phone button from the Got A Question section works correctly ", priority = 38)
