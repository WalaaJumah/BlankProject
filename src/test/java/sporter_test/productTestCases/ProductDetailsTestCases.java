...
public class ProductDetailsTestCases extends BaseTest {
    @Test(groups = {"Product Page", "1.1 Critical Severity"},description = "Make sure the shopper is able to keep the shopping after adding the product to the cart ", priority = 2)
    ...
    @Test(groups = {"Product Page", "1.1 Critical Severity"},description = "Make sure the shopper is able to View the cart after adding the product to it ", priority = 3)
    ...
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Make sure the out of stock message appears when displaying out of stock product ", priority =4)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},dependsOnMethods = "verifyOOSMessageIsDisplayed",description = "Make sure the shopper is unable to add out of stock product to the cart", priority =5,expectedExceptions = { org.openqa.selenium.NoSuchElementException.class })
    public void verifyInabilityToAddOosProductToTheCart(){
        ProductDetailsPage productDetailsPage = new ProductDetailsPage(webDriver);
        Assert.assertFalse(productDetailsPage.getAddToCartBtn().isDisplayed());
    }
    @Test(groups = {"Product Page","All Smoke Testing Result","1.1 Critical Severity"},description = "Make sure to display the product from search screen", priority = 6)
    ...
    @Test(groups = {"Product Page","All Smoke Testing Result","1.2 High Severity"},description = "Make sure that the increase quantity function works fine ", priority = 7)
    ...
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Make sure that the customer is unable to submit his review without selecting any star ", priority = 10)
    ...
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Make sure that the customer can submit his review when filling Review Form with Long Length", priority = 11)
    ...
    @Test(groups = {"Product Page","All Smoke Testing Result","1.2 High Severity"},description = "Make sure that the customer can add the same product more than once by clicking on the Add To Product button in each time ", priority = 13)
    ...
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Make sure that the product price is changed when you change the quantity ", priority = 14)
    ...
    @Test(groups = {"Product Page", "1.1 Critical Severity"},description = "Make sure ability to display the bundle and select all options", priority = 15)
    ...
    @Test(groups = {"Product Page", "1.4 Low Severity"},description = "Verify that the About This product section displays correctly in the PDP", priority = 17)
    ...
    @Test(groups = {"Product Page", "1.4 Low Severity"},description = "Verify that the Supplement Facts section displays correctly in the PDP", priority = 18,enabled = false)
    ...
    @Test(groups = {"Product Page","All Smoke Testing Result","1.4 Low Severity"},description = "Verify that the ShopBy Menu Is Displayed When Hovering On It From Product Details Page", priority = 19)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify that the Sport Supplements Menu Is Displayed When Hovering On It From Product Details Page", priority = 20)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify that the Vitamins And Health Menu Is Displayed When Hovering On It From Product Details Page", priority = 21)
    public void verifyVitaminsAndHealthMenuIsDisplayedWhenHoveringOnItFromProductDetailsPage() {
        ...
        WebElementsAssertion.validateTheElementIsDisplayed(aeMegamenuPage.getVitaminsAndHealthSubMenuSection(), webDriver);
    }
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify that the Healthy Food Menu Is Displayed When Hovering On It From Product Details Page", priority = 22)
    public void verifyHealthyFoodMenuIsDisplayedWhenHoveringOnItFromProductDetailsPage() {
        ...
        WebElementsAssertion.validateTheElementIsDisplayed(aeMegamenuPage.getHealthyFoodSubMenuSection(), webDriver);
    }
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify that the Sports Menu Is Displayed When Hovering On It From Product Details Page", priority = 23)
    public void verifySportsMenuIsDisplayedWhenHoveringOnItFromProductDetailsPage() {
        ...
        WebElementsAssertion.validateTheElementIsDisplayed(aeMegamenuPage.getSportsSubMenuSection(), webDriver);}
    @Test(groups = {"Product Page", "1.1 Critical Severity"},description = "Verify that the account Profile icon works correctly in PDP", priority = 24)
    ...
    @Test(groups = {"Product Page", "1.4 Low Severity"},description = "Verify that the Direction Of Use section displays correctly in the PDP", priority = 25,enabled = false)
...
//        assertTrue(productDetailsPage.getDirectionsOfUseSection().isDisplayed());
    ...
    @Test(groups = {"Product Page", "1.4 Low Severity"},description = "Verify that the About Brand section displays correctly in the PDP", priority = 26,enabled = false)
    ...
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Verify that the header Bar in the PDP appears correctly when scrolling down", priority = 27)
    ...
    @Test(groups = {"Product Page", "1.1 Critical Severity"},description = "Verify that the Add to Cart Button appears in the header Bar in the PDP works correctly ", priority = 28)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify clicking on the By Brand Link appears in Product Name section will redirect the user to correct page ", priority = 29)
    public void verifyClickingOnByBrandLinkAppearsInProductNameSectionRedirectUserToCorrectPage() {
        ...
        WebElementsAssertion.validateTheCurrentUrlContainsString("brands",webDriver);
        productDetailsPage.verifyTheDisplayedPageDoesNotHaveErrors();
    }
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Verify that Expected Delivery Date Label and its value displayed correctly", priority = 30)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Verify that the search button works correctly from the PDP", priority = 31)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Make sure that the next review page button appears in Reviews section works correctly ", priority = 32)
    ...
    //There's bug here
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Make sure that the Previous review page button appears in Reviews section works correctly ", priority = 33)
    ...
    @Test(groups = {"Product Page", "1.2 High Severity"},description = "Make sure that the pagination control appears in Reviews section works correctly ", priority = 34)
    public void verifyPaginationControlAppearsInReviewsSectionWorksCorrectly() {
        ProductDetailsPage productDetailsPage = new ProductDetailsPage(webDriver);
        productDetailsPage.displayTheProduct();
        productDetailsPage.verifyReviewPagingWorks();
    }
    @Test(groups = {"Product Page", "1.3 Medium Severity"},description = "Make sure that the simple price changes when navigation between sizes for the config ", priority = 35,enabled = false)
