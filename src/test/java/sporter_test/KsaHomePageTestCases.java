...
public class KsaHomePageTestCases extends BaseTest {
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure the Banners appear correctly in the HomePage rotating slider section ", priority = 2)
...
//        Assert.assertTrue(ksaHomePage.getHomePageRotatingSlider().isDisplayed());
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the next button at the HomePage rotating slider section is displayed ", priority = 3)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the previous button at the HomePage rotating slider section is displayed ", priority = 4)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the pagination control appears on the HomePage rotating slider is displayed", priority = 5)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure clicking on the banners inside the rotating slider section works correctly", priority = 6)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure the HomePage side Banner is displayed ", priority = 7)
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure the HomePage Horizontal Banner is displayed ", priority = 8)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure clicking on the first side banner works correctly", priority = 9)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure clicking on the second side banner works correctly", priority = 10)
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure clicking on the HomePage Horizontal Banner works correctly", priority = 11)
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure the Shop By Category section is displayed ", priority = 12)
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the main options in the Mega Menu are retrieved correctly", priority = 13)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the Banners appearing under shop by category are displayed", priority = 14)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure the Top Selling Stacks section is displayed ", priority = 15)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","2. High Severity"},description = "KSA HomePage- Make sure clicking on the view all button from the Top Selling Stacks section works correctly ", priority = 16)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure the Top Sellers sections are displayed ", priority = 17)
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","3. Medium Severity"},description = "KSA HomePage- Make sure that all links appear correctly in the Top Sellers section ", priority = 18)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","2. High Severity"},description = "KSA HomePage- Make sure clicking on the All tab from the Top Seller Section works correctly ", priority = 19)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Sport Supplements tab from the Top Seller Section works correctly", priority = 20)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Healthy Food tab from the Top Seller Section works correctly ", priority = 21)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Vitamins And Health tab from the Top Seller Section works correctly ", priority = 22)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Sportswear And Accessories tab from the Top Seller Section works correctly ", priority = 23)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure that previous button in the Top Seller Section works correctly ", priority = 24)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the next button appearing in the Top Seller section works Correctly ", priority = 25)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","2. High Severity"},description = "KSA HomePage- Make sure the Trending On Sporter sections are displayed ", priority = 26)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the next button appearing in the Trending On Sporter section works Correctly ", priority = 27)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure the previous button appearing in the Trending On Sporter section works Correctly ", priority = 28)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","2. High Severity"},description = "KSA HomePage- Make sure the New Arrivals sections are displayed ", priority = 29)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","3. Medium Severity"},description = "KSA HomePage- Make sure that all links appearing correctly in the New Arrivals section ", priority = 30)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the all tab from the New Arrivals Section works correctly", priority = 31)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Sport Supplements tab from the New Arrivals Section works correctly ", priority = 32)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Healthy Food tab that appear in the New Arrivals Section works correctly ", priority = 33)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Vitamins And Health tab from the New Arrivals Section works correctly", priority = 34)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure clicking on the Sportswear And Accessories tab from the New Arrivals Section works correctly ", priority = 35)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","3. Medium Severity"},description = "KSA HomePage- Make sure that previous and next button in the New Arrivals Section works correctly", priority = 36)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","3. Medium Severity"},description = "KSA HomePage- Make sure the Got A Question section is displayed ", priority = 37)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","All Smoke Testing Result","1. Critical Severity"},description = "KSA HomePage- Make sure the clicking on email button from the Got A Question section works correctly ", priority = 38)
...
//        ksaHomePage.navigate();
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure clicking on the Sports Supplements category from the HomePage works correctly ", priority = 39)
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure clicking on the Healthy Food category from the HomePage works correctly ", priority = 40)
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure clicking on the Vitamins And Health category from the HomePage works correctly ", priority = 41)
    ...
    @Test(groups = {"Home Page","1. Critical Severity"},description = "KSA HomePage- Make sure clicking on the Sportswear & Accessories category from the HomePage works correctly ", priority = 42)
    ...
    @Test(groups = {"Home Page","2. High Severity"},description = "KSA HomePage- Make sure clicking on phone button from the Got A Question section works correctly ", priority = 47)
