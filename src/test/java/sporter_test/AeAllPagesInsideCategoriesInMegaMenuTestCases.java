...
public class AeAllPagesInsideCategoriesInMegaMenuTestCases  extends BaseTest {
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sport Supplements Category Page", priority = 1)
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Protein Sub-Category related to the Sport Supplements Category ", priority = 2)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), proteinOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Whey Protein Sub-Category related to the Sport Supplements Category ", priority = 3)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), wheyProteinOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Whey Protein Isolate Sub-Category related to the Sport Supplements Category ", priority = 4)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), WheyProteinIsolateOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Protein Blends Sub-Category related to the Sport Supplements Category ", priority = 5)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), proteinBlendsOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Non Dairy Protein Sub-Category related to the Sport Supplements Category ", priority = 6)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), nonDairyProteinOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Casein Protein Sub-Category related to the Sport Supplements Category ", priority = 7)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), caseinProteinOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Diet Protein Sub-Category related to the Sport Supplements Category ", priority = 8)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), dietProteinOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Mass Gainers Sub-Category related to the Sport Supplements Category ", priority = 9)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), massGainersOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Creatine Sub-Category related to the Sport Supplements Category ", priority = 10)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), creatineOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Creatine Monohydrate Sub-Category related to the Sport Supplements Category ", priority = 11)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), creatineMonohydrateOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Creatine Blends Sub-Category related to the Sport Supplements Category ", priority = 12)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), creatineBlendsOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino Acids Sub-Category related to the Sport Supplements Category ", priority = 13)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoAcidsOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside BCAA Sub-Category related to the Sport Supplements Category ", priority = 14)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), bCAAOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside EAA Sub-Category related to the Sport Supplements Category ", priority = 15)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), eAAOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Arginine Sub-Category related to the Sport Supplements Category ", priority = 16)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), arginineOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Beta Alanine Sub-Category related to the Sport Supplements Category ", priority = 17)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), betaAlanineOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside HMb Sub-Category related to the Sport Supplements Category ", priority = 18)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), hMBOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino Acid Powders Sub-Category related to the Sport Supplements Category ", priority = 19)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoAcidPowdersOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino Acid Pills Sub-Category related to the Sport Supplements Category ", priority = 20)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoAcidPillsOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Citrulline Sub-Category related to the Sport Supplements Category ", priority = 21)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), citrullineOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino Acid Liquids Sub-Category related to the Sport Supplements Category ", priority = 22)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoAcidLiquidsOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Muscle Boosters Sub-Category related to the Sport Supplements Category ", priority = 23)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), muscleBoostersOptionInSportSupplementsMenuUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Testosterone Boosters Sub-Category related to the Sport Supplements Category ", priority = 24)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), testosteroneBoostersOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Gh Booster Sub-Category related to the Sport Supplements Category ", priority = 25)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), ghBoostersOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Weight Management Sub-Category related to the Sport Supplements Category ", priority = 26)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), weightManagementOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Stimulant Weight Loss Sub-Category related to the Sport Supplements Category ", priority = 27)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), stimulantWeightLossOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Non Stimulant Weight Loss Sub-Category related to the Sport Supplements Category ", priority = 28)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), nonStimulantWeightLossOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Meal Replacements Sub-Category related to the Sport Supplements Category ", priority = 29)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), mealReplacementsOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Metabolism Support Sub-Category related to the Sport Supplements Category ", priority = 30)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), metabolismSupportOptionInSportSupplementsMenuUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Toning Creams Sub-Category related to the Sport Supplements Category ", priority = 31)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), toningCreamsOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Mct Sub-Category related to the Sport Supplements Category ", priority = 32)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), mctOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Recovery Sub-Category related to the Sport Supplements Category ", priority = 33)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), recoveryOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Glutamine Sub-Category related to the Sport Supplements Category ", priority = 34)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), glutamineOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Recovery Blend Sub-Category related to the Sport Supplements Category ", priority = 35)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), recoveryBlendOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Electrolytes And Hydration Sub-Category related to the Sport Supplements Category ", priority = 36)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), electrolytesAndHydrationOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Carbohydrates Sub-Category related to the Sport Supplements Category ", priority = 37)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), carbohydratesOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Carbohydrate Powders Sub-Category related to the Sport Supplements Category ", priority = 38)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), carbohydratePowdersOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Energy And Endurance Sub-Category related to the Sport Supplements Category ", priority = 39)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), energyAndEnduranceOptionInSportSupplementsMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Stimulant Energy Sub-Category related to the Sport Supplements Category ", priority = 40)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Non Stimulant Energy Sub-Category related to the Sport Supplements Category ", priority = 41)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Gaming And Focus Sub-Category related to the Sport Supplements Category ", priority = 42)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Gaming Essentials Sub-Category related to the Sport Supplements Category ", priority = 43)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), gamingEssentialsOptionInSportSupplementsMenuUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Featured Sub-Category related to the Vitamins & Health Category ", priority = 44)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), featuredOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Best Sellers Sub-Category related to the Vitamins & Health Category ", priority = 45)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aliveVitaminsOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sexual Health Sub-Category related to the Vitamins & Health Category ", priority = 46)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sexualHealthOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Essential Vitamins Sub-Category related to the Vitamins & Health Category ", priority = 47)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), essentialVitaminsOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Folic Acid Sub-Category related to the Vitamins & Health Category ", priority = 48)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), folicAcidOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin A Sub-Category related to the Vitamins & Health Category ", priority = 49)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminAOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin B Sub-Category related to the Vitamins & Health Category ", priority = 50)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminBOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin C Sub-Category related to the Vitamins & Health Category ", priority = 51)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminCOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin D Sub-Category related to the Vitamins & Health Category ", priority = 52)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminDOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin E Sub-Category related to the Vitamins & Health Category ", priority = 53)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminEOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamin K Sub-Category related to the Vitamins & Health Category ", priority = 54)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminKOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Multi Vitamins Sub-Category related to the Vitamins & Health Category ", priority = 55)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), multiVitaminsOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamins For Kids Sub-Category related to the Vitamins & Health Category ", priority = 56)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminsForKidsOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamins For Men Sub-Category related to the Vitamins & Health Category ", priority = 57)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminsForMenOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Vitamins For Women Sub-Category related to the Vitamins & Health Category ", priority = 58)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), vitaminsForWomenOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Bone And Joint Sub-Category related to the Vitamins & Health Category ", priority = 59)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), boneJointOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Bone Health Sub-Category related to the Vitamins & Health Category ", priority = 60)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), boneHealthOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Joint Health Sub-Category related to the Vitamins & Health Category ", priority = 61)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), jointHealthOptionInVitaminsAndHealthUrl);
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Beauty Sub-Category related to the Vitamins & Health Category ", priority = 62)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), beautyOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Collagen Sub-Category related to the Vitamins & Health Category ", priority = 63)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), collagenOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Hair Skin And Nails Sub-Category related to the Vitamins & Health Category ", priority = 64)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), hairSkinAndNailsOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Fish Oil Omegas Sub-Category related to the Vitamins & Health Category ", priority = 65)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), fishOilAndOmegasOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Fish Oil Sub-Category related to the Vitamins & Health Category ", priority = 66)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), fishOilOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Omega369 Sub-Category related to the Vitamins & Health Category ", priority = 67)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), omegaMixOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Health Life style Sub-Category related to the Vitamins & Health Category ", priority = 68)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), healthyLifestyleOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Antioxidants Sub-Category related to the Vitamins & Health Category ", priority = 69)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), antioxidantOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Blood Sugar Support Sub-Category related to the Vitamins & Health Category ", priority = 70)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), bloodSugarSupportOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Brain Support Sub-Category related to the Vitamins & Health Category ", priority = 71)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), brainSupportOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Detox And Cleans Sub-Category related to the Vitamins & Health Category ", priority = 72)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), detoxCleanseOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Energy Formulas Sub-Category related to the Vitamins & Health Category ", priority = 74)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), energyFormulasOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Eye Health Sub-Category related to the Vitamins & Health Category ", priority = 75)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), eyeHealthOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Herbs Option Sub-Category related to the Vitamins & Health Category ", priority = 76)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), herbsOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Hormones Balance Option Sub-Category related to the Vitamins & Health Category ", priority = 77)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), hormonesBalanceOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Immune Support Option Sub-Category related to the Vitamins & Health Category ", priority = 78)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), immuneSupportOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Mens Health Option Sub-Category related to the Vitamins & Health Category ", priority = 79)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), mensHealthOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Stress Relief Option Sub-Category related to the Vitamins & Health Category ", priority = 80)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), stressReliefOptionInVitaminsAndHealthUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sleep Support Option Sub-Category related to the Vitamins & Health Category ", priority = 81)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sleepSupportOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Super Foods Option Sub-Category related to the Vitamins & Health Category ", priority = 82)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), superFoodsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Urinary Tract Support Option Sub-Category related to the Vitamins & Health Category ", priority = 83)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), urinaryTractSupportOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Weight Management Option Sub-Category related to the Vitamins & Health Category ", priority = 84)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), weightManagementOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Womens Health  Option Sub-Category related to the Vitamins & Health Category ", priority = 85)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), womenesHealthOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Digestion Option Sub-Category related to the Vitamins & Health Category ", priority = 86)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), digestionOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Digestion Support Option Sub-Category related to the Vitamins & Health Category ", priority = 87)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), digestionSupportOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Probiotics Option Sub-Category related to the Vitamins & Health Category ", priority = 88)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), probioticsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sport Vitamins Option Sub-Category related to the Vitamins & Health Category ", priority = 89)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sportVitaminsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino Acid Option Sub-Category related to the Vitamins & Health Category ", priority = 90)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoAcidOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Minerals Option Sub-Category related to the Vitamins & Health Category ", priority = 91)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), mineralsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Calcium Option Sub-Category related to the Vitamins & Health Category ", priority = 92)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), calciumOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Iron Option Sub-Category related to the Vitamins & Health Category ", priority = 93)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), ironOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Magnesium Option Sub-Category related to the Vitamins & Health Category ", priority = 94)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), magnesiumOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Multi mineral Formulas Option Sub-Category related to the Vitamins & Health Category ", priority = 95)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), multimineralFormulasOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Zinc Option Sub-Category related to the Vitamins & Health Category ", priority = 96)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), zincOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Potassium Option Sub-Category related to the Vitamins & Health Category ", priority = 97)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), potassiumOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Drinks Option Sub-Category related to the Vitamins & Health Category ", priority = 98)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), healthyDrinksOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Drinkable Vitamins Option Sub-Category related to the Vitamins & Health Category ", priority = 99)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), drinkableVitaminsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Pets Option Sub-Category related to the Vitamins & Health Category ", priority = 100)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), petsOptionInVitaminsAndHealthUrl);
  ...
  @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Supplements More Option Sub-Category related to the Vitamins & Health Category ", priority = 101)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Food Category Page", priority = 102)
public void verifyAbilityToAccessAllPagesInsideHealthyFoodCategoryPageFromMegaMenu(){
    ...
    @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Grocery Option Sub-Category related to the Healthy Food Category ", priority = 103)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), groceryOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Baking And Cooking Option Sub-Category related to the Healthy Food Category ", priority = 104)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), bakingAndCookingOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Canned Option Sub-Category related to the Healthy Food Category ", priority = 105)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), cannedOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Coffee Option Sub-Category related to the Healthy Food Category ", priority = 106)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), coffeeOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Condiments Option Sub-Category related to the Healthy Food Category ", priority = 107)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), condimentsOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Milk And Cream Option Sub-Category related to the Healthy Food Category ", priority = 108)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), milkAndCreamOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Nuts And Oats Option Sub-Category related to the Healthy Food Category ", priority = 109)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), nutsAndOatsOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Oils Option Sub-Category related to the Healthy Food Category ", priority = 110)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), oilsOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Pasta Option Sub-Category related to the Healthy Food Category ", priority = 111)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), pastaOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Rice And Grains Option Sub-Category related to the Healthy Food Category ", priority = 112)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), riceAndGrainsOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Seasonings Option Sub-Category related to the Healthy Food Category ", priority = 113)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), seasoningsAndSpicessOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sugar Sweeteners Option Sub-Category related to the Healthy Food Category ", priority = 114)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sugarAndSweetenersOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Syrups Option Sub-Category related to the Healthy Food Category ", priority = 115)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), syrupsOptionInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Tea And Herbs Option Sub-Category related to the Healthy Food Category ", priority = 116)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), teaAndHerbsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Superfoods Option Sub-Category related to the Healthy Food Category ", priority = 117)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), superFoodsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Ready Mixes Option Sub-Category related to the Healthy Food Category ", priority = 118)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), readyMixInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Breakfast And Cereal Option Sub-Category related to the Healthy Food Category ", priority = 119)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), breakfastAndCerealInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Ready To Drink Option Sub-Category related to the Healthy Food Category ", priority = 120)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), readyToDrinkInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Amino And Bcaas Option Sub-Category related to the Healthy Food Category ", priority = 121)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), aminoBcaasInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Energy Drinks Option Sub-Category related to the Healthy Food Category ", priority = 122)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), energyDrinksInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Protein Shakes Option Sub-Category related to the Healthy Food Category ", priority = 123)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), proteinShakesInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Electrolytes And Hydration Option Sub-Category related to the Healthy Food Category ", priority = 124)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), electrolytesAndHydrationInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Snacks Option Sub-Category related to the Healthy Food Category ", priority = 125)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), healthySnacksInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Protein Bars Option Sub-Category related to the Healthy Food Category ", priority = 126)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), proteinBarsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Cookies Option Sub-Category related to the Healthy Food Category ", priority = 127)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), cookiesInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Chips Option Sub-Category related to the Healthy Food Category ", priority = 128)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), chipsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Brownies And Pancakes Option Sub-Category related to the Healthy Food Category ", priority = 129)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), browniesAndPancakesInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Snack Bars Option Sub-Category related to the Healthy Food Category ", priority = 130)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), snackBarsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Spreads Option Sub-Category related to the Healthy Food Category ", priority = 131)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), spreadsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Other Healthy Snacks Option Sub-Category related to the Healthy Food Category ", priority = 132)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), otherHealthySnacksInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Ready To Eat Option Sub-Category related to the Healthy Food Category ", priority = 133)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), readyToEatInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Meals Option Sub-Category related to the Healthy Food Category ", priority = 134)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), healthyMealsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Featured Option Sub-Category related to the Healthy Food Category ", priority = 135)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), featuredInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Healthy Meal Replacement Option Sub-Category related to the Healthy Food Category ", priority = 136)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), healthyMealReplacementInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Protein Option Sub-Category related to the Healthy Food Category ", priority = 137)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), proteinCoffeeInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Candies Option Sub-Category related to the Healthy Food Category ", priority = 138)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), candiesInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Flavoring Agents Option Sub-Category related to the Healthy Food Category ", priority = 139)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), flavoringAgentsInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Keto Option Sub-Category related to the Healthy Food Category ", priority = 140)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), ketoSnacksInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Manuka Honey Option Sub-Category related to the Healthy Food Category ", priority = 141)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), manukaHoneyInHealthyFoodUrl);
   ...
   @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Meat Snacks Option Sub-Category related to the Healthy Food Category ", priority = 142)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Men Option Sub-Category related to the Sports Category ", priority = 143)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), menInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sport Option Sub-Category related to the Sports Category ", priority = 144)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sportInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Football Option Sub-Category related to the Sports Category ", priority = 145)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), footballInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Basketball Option Sub-Category related to the Sports Category ", priority = 146)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), basketballInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Baseball Option Sub-Category related to the Sports Category ", priority = 147)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), baseballInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Running Option Sub-Category related to the Sports Category ", priority = 148)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), runningInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Safety Swimming Option Sub-Category related to the Sports Category ", priority = 149)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), swimmingInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Yoga Option Sub-Category related to the Sports Category ", priority = 150)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), yogaInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Fitness And Training1 Option related to the Sports Category ", priority = 151)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), fitnessAndTrainingInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Mma Option Sub-Category related to the Sports Category ", priority = 152)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), mmaInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside JiuJitsu Option Sub-Category related to the Sports Category ", priority = 153)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), jiuJitsuInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Board Games Option Sub-Category related to the Sports Category ", priority = 154)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), boardGamesInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sports Tech Option Sub-Category related to the Sports Category ", priority = 155)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), sportsTechInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Wearable Tech Option Sub-Category related to the Sports Category ", priority = 156)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), wearableTechInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Cameras Option Sub-Category related to the Sports Category ", priority = 157)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), camerasInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Phone Accessories Option Sub-Category related to the Sports Category ", priority = 158)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), phoneAccessoriesInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Personal Care Option Sub-Category related to the Sports Category ", priority = 159)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), personalCareInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu","All Smoke Testing Result","1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Showering Option Sub-Category related to the Sports Category ", priority = 160)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), showeringInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu","All Smoke Testing Result","1.3 Medium Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Shaving Option Sub-Category related to the Sports Category ", priority = 161)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), shavingInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu","All Smoke Testing Result","1.3 Medium Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Skin Care Option Sub-Category related to the Sports Category ", priority = 162)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), skinCareInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Body Care Option Sub-Category related to the Sports Category ", priority = 163)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), bodyCareInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Oral Care Option Sub-Category related to the Sports Category ", priority = 164)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), oralCareInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Therapy Option Sub-Category related to the Sports Category ", priority = 165)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), therapyInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Masks Option Sub-Category related to the Sports Category ", priority = 166)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), masksInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Fitness And Training Option Sub-Category related to the Sports Category ", priority = 167)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), fitnessAndTrainingCategoryInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Fitness Equipment Option Sub-Category related to the Sports Category ", priority = 168)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), fitnessEquipmentInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Skipping Ropes Option Sub-Category related to the Sports Category ", priority = 169)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), skippingRopesInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the " +
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), weightBeltsInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Scooters Option Sub-Category related to the Sports Category ", priority = 171)
...
//        Assert.assertEquals(webDriver.getCurrentUrl(), scootersInSportsMainMenuUrl);
 ...
 @Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside  Training Accessories Option Sub-Category related to the Sports Category ", priority = 172)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Shakers And Bottles Option Sub-Category related to the Sports Category ", priority = 173)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Bags Option Sub-Category related to the Sports Category ", priority = 174)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Gloves Option Sub-Category related to the Sports Category ", priority = 175)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Braces And Sleeves Option Sub-Category related to the Sports Category ", priority = 176)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Mouthguard Option Sub-Category related to the Sports Category ", priority = 177)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Appeal Option Sub-Category related to the Sports Category ", priority = 178)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sportswear Option Sub-Category related to the Sports Category ", priority = 179)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Pants Option Sub-Category related to the Sports Category ", priority = 180)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Shorts Option Sub-Category related to the Sports Category ", priority = 181)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Hoodies Option Sub-Category related to the Sports Category ", priority = 182)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside TShirts Option Sub-Category related to the Sports Category ", priority = 183)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Tanks Option Sub-Category related to the Sports Category ", priority = 184)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Footwear Option Sub-Category related to the Sports Category ", priority = 185)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Sneakers Option Sub-Category related to the Sports Category ", priority = 186)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Training Shoes Option Sub-Category related to the Sports Category ", priority = 187)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Running Shoes Option Sub-Category related to the Sports Category ", priority = 188)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Option Sub-Category related to the Sports Category ", priority = 189)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Sports Tech Option Sub-Category related to the Sports Category ", priority = 190)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Wearable Tech Option Sub-Category related to the Sports Category ", priority = 191)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Cameras Option Sub-Category related to the Sports Category ", priority = 192)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Phone Accessories Option Sub-Category related to the Sports Category ", priority = 193)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Personal Care Option Sub-Category related to the Sports Category ", priority = 194)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Showering Option Sub-Category related to the Sports Category ", priority = 195)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Skin Care Option Sub-Category related to the Sports Category ", priority = 196)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Body Care Option Sub-Category related to the Sports Category ", priority = 197)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Oral Care Option Sub-Category related to the Sports Category ", priority = 198)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Therapy Option Sub-Category related to the Sports Category ", priority = 199)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Masks Option Sub-Category related to the Sports Category ", priority = 200)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Fitness And Training Option Sub-Category related to the Sports Category ", priority = 201)
...
@Test(groups = {"MegaMenu", "1.2 High Severity"},description = "MegaMenu- Make Sure the ability to access all pages inside Women Training Accessories Option Sub-Category related to the Sports Category ", priority = 202)
