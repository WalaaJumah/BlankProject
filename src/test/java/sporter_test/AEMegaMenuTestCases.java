...
public class AEMegaMenuTestCases extends BaseTest {
    ...
    @Test(groups = "Smoke Testing Result",description = "MegaMenu- Switching to the UAE Store", priority = 1)
...
//                //aeMegamenuPage.navigateToHomePage();
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","4. Low Severity"},description = "MegaMenu- Make sure the Category sub menu will appear once hovering on any option appearing in the ShopBy Menu", priority = 7)
...
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(womenOnlyUrl));
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the By Brand menu appearing in the ShopBy Menu will redirect the User to the correct URL", priority = 18)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the By Goal menu appearing in the ShopBy Menu will redirect the User to the correct URL", priority = 19)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Sales And Offers menu appearing in the ShopBy Menu will redirect the User to the correct URL", priority = 21)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Sport Stacks menu appearing in the ShopBy Menu will redirect the User to the correct URL", priority = 23)
...
//
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","2. High Severity"},description = "MegaMenu- Make sure clicking on the Protein option appearing in the Sports Supplements menu inside ShopBy Menu will redirect the User to the correct URL", priority = 28)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Creatine option appearing in the Sports Supplements menu inside ShopBy Menu will redirect the User to the correct URL", priority = 29)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Amino Acids appearing in the Sports Supplements inside menu ShopBy Menu will redirect the User to the correct URL", priority = 30)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Muscle Boosters option appearing in the Sports Supplements menu inside ShopBy Menu will redirect the User to the correct URL", priority = 31)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the HMB Option appearing in the Sports Supplements menu inside ShopBy Menu will redirect the User to the correct URL", priority = 50)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Featured Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 73)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Alive Vitamins Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 74)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Sexual Health Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 75)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Essential Vitamins Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 76)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Folic Acid Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 77)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin A Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 78)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin B Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 79)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin C Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 80)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin D Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 81)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin E Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 82)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamin K Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 83)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Multi Vitamins Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 84)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamins For Kids Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 85)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamins For Men Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 86)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Vitamins For Women Option appearing in the Vitamins & Health menu inside ShopBy Menu will redirect the User to the correct URL", priority = 87)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Condiments Option appearing in the Healthy Food menu inside ShopBy Menu will redirect the User to the correct URL", priority = 135)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Superfoods Option appearing in the Healthy Food menu inside ShopBy Menu will redirect the User to the correct URL", priority = 145)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Ready Mixes Option appearing in the Healthy Food menu inside ShopBy Menu will redirect the User to the correct URL", priority = 146)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Pants Option appearing in the Sports menu inside ShopBy Menu will redirect the User to the correct URL", priority = 177)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Shorts Option appearing in the Sports menu inside ShopBy Menu will redirect the User to the correct URL", priority = 178)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Safety Masks Option appearing in the Sports menu inside ShopBy Menu will redirect the User to the correct URL", priority = 180)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Footwear Option appearing in the Sports menu inside ShopBy Menu will redirect the User to the correct URL", priority = 181)
...
Assert.assertTrue(aeMegamenuPage.verifyTheMegaMenuAppearsInThePage()," The MegaMenu is missing");
    ...
    @Test(groups = {"MegaMenu","Smoke Testing Result","3. Medium Severity"},description = "MegaMenu- Make sure clicking on the Wearable Tech Option appearing in the Sports menu inside ShopBy Menu will redirect the User to the correct URL", priority = 201)
