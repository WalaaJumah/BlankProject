...
public void switchToQatarStore(){
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the next button at the HomePage rotating slider section is displayed ", priority = 3)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the previous button at the HomePage rotating slider section is displayed ", priority = 4)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the pagination control appears on the HomePage rotating slider is displayed", priority = 5)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the banners inside the rotating slider section works correctly", priority = 6)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure the HomePage side Banners is displayed ", priority = 7)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure the HomePage Horizontal Banner is displayed ", priority = 8)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the first side banner works correctly", priority = 9)
...
//        WebElementsAssertion.validateTheCurrentUrlContainsString(expectedUrl, webDriver);
    ...
    //TODO: Activate the validation rule when deployed the site into production as discussed with Moamen
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the second side banner works correctly", priority = 10)
...
//        WebElementsAssertion.validateTheCurrentUrlContainsString(expectedUrl, webDriver);
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the HomePage Horizontal Banner works correctly", priority = 11)
...
//        WebElementsAssertion.validateTheCurrentUrlContainsString(expectedUrl, webDriver);
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure the Shop By Category section is displayed ", priority = 12)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the main options in the Mega Menu are retrieved correctly", priority = 13)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the Banners appearing under shop by category are displayed", priority = 14)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure the Top Selling Stacks section is displayed ", priority = 15)
    ...
    @Test(groups = { "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the view all button from the Top Selling Stacks section works correctly ", priority = 16)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure the Top Sellers sections are displayed ", priority = 17)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure that all links appear correctly in the Top Sellers section ", priority = 18)
    ...
    @Test(groups = { "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Categories tabs appearing in the Top Sellers section are working correctly", priority = 19)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the next button appearing in the Top Seller section works Correctly ", priority = 24)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure that previous button in the Top Seller Section works correctly ", priority = 25)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure the Trending On Sporter sections are displayed ", priority = 26)
    ...
    @Test(groups = { "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure the New Arrivals sections are displayed ", priority = 29)
    ...
    @Test(groups = { "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Categories tabs appearing in the New Arrivals section are working correctly", priority = 19)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure that previous and next button in the New Arrivals Section works correctly", priority = 36)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.3 Medium Severity"}, description = "(Qatar Store/English Version):Make sure the Got A Question section is displayed ", priority = 37)
    ...
    @Test(groups = { "All Smoke Testing Result", "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure the clicking on email button from the Got A Question section works correctly ", priority = 38)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Sports Supplements category from the HomePage works correctly ", priority = 39)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Healthy Food category from the HomePage works correctly ", priority = 40)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Vitamins And Health category from the HomePage works correctly ", priority = 41)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the Sportswear & Accessories category from the HomePage works correctly ", priority = 42)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the products appearing in the Top Selling Stacks section works correctly", priority = 43)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the products appearing in the Top Sellers section works correctly", priority = 44)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure clicking on the products appearing in the New Arrivals section works correctly", priority = 45)
    ...
    @Test(groups = { "1.1 Critical Severity"}, description = "(Qatar Store/English Version):Make sure ability to access all categories inside Trending On Sporter Section Correctly", priority = 46)
    ...
    @Test(groups = { "1.2 High Severity"}, description = "(Qatar Store/English Version):Make sure clicking on phone button from the Got A Question section works correctly ", priority = 47)
