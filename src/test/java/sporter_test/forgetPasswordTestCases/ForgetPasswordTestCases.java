...
public class ForgetPasswordTestCases extends BaseTest {
    ...
    @Test(groups = {"1.3 Medium Severity"}, description = "{{CountryName}}: Make sure the Cart icon appears correctly", priority = 3)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "{{CountryName}}: Make sure the My Account icon appears correctly", priority = 4)
    ...
    @Test(groups = { "1.3 Medium Severity"}, description = "{{CountryName}}: Make sure the Sporter Logo appears correctly", priority = 5)
    ...
    @Test(groups = {"All Smoke Testing Result", "1.3 Medium Severity"}, description = "{{CountryName}}: Verify Back To Login Button that appears in the Forget Password page works correctly", priority = 6)
    ...
    @Test(groups = {"1.3 Medium Severity"}, description = "{{CountryName}}: Verify Inability to click on Submit Button from the Forget Password page without filling Email Address", priority = 7)
    ...
    @Test(groups = {"1.3 Medium Severity"}, description = "{{CountryName}}: Verify Inability to click on Submit Button with wrong email format and the correct error Msg appears", priority = 8)
    ...
    @Test(groups = {"1.3 Medium Severity"}, description = "{{CountryName}}: Verify Submit button in the Forget Password Page works correctly", priority = 9)
