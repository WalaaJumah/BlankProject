...
public void switchToUaeStore(){
    ...
    @Test(groups = {"Sports Supplements Category","Smoke Testing Result","1. Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category Appears In MegaMenu Redirect User To CorrectURL", priority = 2)
    ...
    @Test(groups = {"Sports Supplements Category","Smoke Testing Result","1. Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category from ShopBy Menu Redirect User To CorrectURL", priority = 3)
...
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(sportSupplementsUrl));
    ...
    @Test(groups = {"Sports Supplements Category","Smoke Testing Result","1. Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category from HomePage Redirect User To CorrectURL", priority = 4)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category","Smoke Testing Result","2. High Severity"},description = "Sports Supplements Category- Make sure clicking on the Horizontal Banners works correctly ", priority = 8)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category","Smoke Testing Result","4. Low Severity"},description = "Sports Supplements Category- Make sure that the customer can navigate to the home page using the BreadCrumb ", priority = 9)
