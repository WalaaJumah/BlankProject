...
public class AeProductDetailsPageTestCases extends BaseTest {
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","2. High Severity"},description = "Make sure to display the product from search screen", priority = 6)
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","2. High Severity"},description = "Make sure that the increase quantity function works fine ", priority = 7)
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","2. High Severity"},description = "Make sure that the Decrease quantity function works fine ", priority = 8)
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","3. Medium Severity"},description = "Make sure that the customer can submit his review successfully ", priority = 9)
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","2. High Severity"},description = "Make sure that the customer can add the same product more than once by clicking on the Add To Product button in each time ", priority = 13)
    ...
    @Test(groups = {"Product Page","Smoke Testing Result","4. Low Severity"},description = "Verify that the ShopBy Menu Is Displayed When Hovering On It From Product Details Page", priority = 19)
