...
public class UAERecommendedProductTestCases extends RecommendedProductTestCases {
    ...
    @Test(groups = {"All Smoke Testing Result","1.2 High Severity"},description = "(UAE Store/ English Version): Make sure ability to add Recommended product to the cart", priority = 7)
    ...
    @Test(groups = {"1.3 Medium Severity"},description = "(UAE Store/ English Version): Make sure the name of product added to the Cart displayed correctly in the Recommended product pop-up", priority = 8)
    ...
    @Test(groups = {"1.3 Medium Severity"},description = "(UAE Store/ English Version): Make sure the product price displayed in the Recommended product pop-up matches with the product price displayed in PDP", priority = 9)
