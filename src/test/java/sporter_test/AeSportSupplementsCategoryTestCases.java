...
public void switchToUaeStore(){
    ...
    @Test(groups = {"Sports Supplements Category","All Smoke Testing Result","1.1 Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category Appears In MegaMenu Redirect User To CorrectURL", priority = 2)
    ...
    @Test(groups = {"Sports Supplements Category","All Smoke Testing Result","1.1 Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category from ShopBy Menu Redirect User To CorrectURL", priority = 3)
...
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(sportSupplementsUrl));
    ...
    @Test(groups = {"Sports Supplements Category","All Smoke Testing Result","1.1 Critical Severity"},description = "Sports Supplements Category- Make sure clicking on the Sports Supplements Category from HomePage Redirect User To CorrectURL", priority = 4)
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure the Horizontal Category Image appears correctly in the landing page ", priority = 5)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure each of the title and Paragraph appearing in the Horizontal Category Image appears correctly", priority = 6)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.2 High Severity"},description = "Sports Supplements Category- Make sure the Horizontal Banners appear correctly", priority = 7)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category","All Smoke Testing Result","1.2 High Severity"},description = "Sports Supplements Category- Make sure clicking on the Horizontal Banners works correctly ", priority = 8)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category","All Smoke Testing Result","1.4 Low Severity"},description = "Sports Supplements Category- Make sure that the customer can navigate to the home page using the BreadCrumb ", priority = 9)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category Page- Make sure that the Result label and its value appear correctly ", priority = 10)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category Page- Make sure that Sort By menu and its options appear correctly ", priority = 11)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure that the Best Selling option is selected by default in the Sort By menu ", priority = 12)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make sure each of the Sport Supplements category image and Horizontal Banners appearing after sorting the products  ", priority = 13)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make sure Sort By Menu appears correctly in the page after sorting By Featured  ", priority = 14)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make sure Sort By Menu appears correctly in the page after sorting By Price Min-Max  ", priority = 15)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make sure Sort By Menu appears correctly in the page after sorting By Price Max-Min  ", priority = 16)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure  the Sport Supplements footer appears correctly  ", priority = 17)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure the text appears in the Sport Supplements footer appears correctly  ", priority = 18)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.2 High Severity"},description = "Sports Supplements Category- Verify that the search button works correctly from the Sport Supplements category page", priority = 19)
...
//        aeSportSupplementsCategoryPage.navigate();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Verify that the previous page button is disable when the current page is page 1 ", priority = 20)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make Sure the Pagination control works correctly", priority = 21)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make Sure the previous page button works correctly", priority = 22)
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make Sure the next page button works correctly", priority = 23)
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make Sure All Search Fields Inside Form Filtration Section Appears Correctly", priority = 24)
...
//        }
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure all secure tabs appears correctly(100% Secure Payments+ 100% Authentic Products+Fast Delivery Service blocks)", priority = 25)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.4 Low Severity"},description = "Sports Supplements Category- Make sure that the BreadCrumb appears correctly after sorting the product ", priority = 27)
...
//        this.verifyClickingOnSportsSupplementsCategoryAppearsInMegaMenuRedirectUserToCorrectURL();
    ...
    @Test(groups = {"Sports Supplements Category", "1.3 Medium Severity"},description = "Sports Supplements Category- Make sure ability to navigate to the home page by clicking on the sporter logo  ", priority = 28)
