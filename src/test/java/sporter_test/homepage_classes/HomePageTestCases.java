...
public class HomePageTestCases extends BaseTest {
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure the Banners appear correctly in the HomePage rotating slider section ", priority = 2)
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the next button at the HomePage rotating slider section is displayed ", priority = 3)
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the previous button at the HomePage rotating slider section is displayed ", priority = 4)
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the pagination control appears on the HomePage rotating slider is displayed", priority = 5)
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure clicking on the banners inside the rotating slider section works correctly", priority = 6)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure the HomePage side Banners is displayed ", priority = 7)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure the HomePage Horizontal Banner is displayed ", priority = 8)
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure clicking on the first side banner works correctly", priority = 9)
...
//        Assert.assertTrue(webDriver.getCurrentUrl().contains(expectedUrl), "Incorrect URL is displayed " + webDriver.getCurrentUrl());
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure clicking on the second side banner works correctly", priority = 10)
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure clicking on the HomePage Horizontal Banner works correctly", priority = 11)
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure the Shop By Category section is displayed ", priority = 12)
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the main options in the Mega Menu are retrieved correctly", priority = 13)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the Banners appearing under shop by category are displayed", priority = 14)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure the Top Selling Stacks section is displayed ", priority = 15)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "2. High Severity"}, description = "HomePage- Make sure clicking on the view all button from the Top Selling Stacks section works correctly ", priority = 16)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure the Top Sellers sections are displayed ", priority = 17)
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "3. Medium Severity"}, description = "HomePage- Make sure that all links appear correctly in the Top Sellers section ", priority = 18)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "2. High Severity"}, description = "HomePage- Make sure clicking on the All tab from the Top Seller Section works correctly ", priority = 19)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Sport Supplements tab from the Top Seller Section works correctly", priority = 20)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Healthy Food tab from the Top Seller Section works correctly ", priority = 21)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Vitamins And Health tab from the Top Seller Section works correctly ", priority = 22)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Sportswear And Accessories tab from the Top Seller Section works correctly ", priority = 23)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure that previous button in the Top Seller Section works correctly ", priority = 24)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the next button appearing in the Top Seller section works Correctly ", priority = 25)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "2. High Severity"}, description = "HomePage- Make sure the Trending On Sporter sections are displayed ", priority = 26)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the next button appearing in the Trending On Sporter section works Correctly ", priority = 27)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure the previous button appearing in the Trending On Sporter section works Correctly ", priority = 28)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "2. High Severity"}, description = "HomePage- Make sure the New Arrivals sections are displayed ", priority = 29)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "3. Medium Severity"}, description = "HomePage- Make sure that all links appearing correctly in the New Arrivals section ", priority = 30)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the all tab from the New Arrivals Section works correctly", priority = 31)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Sport Supplements tab from the New Arrivals Section works correctly ", priority = 32)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Healthy Food tab that appear in the New Arrivals Section works correctly ", priority = 33)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Vitamins And Health tab from the New Arrivals Section works correctly", priority = 34)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure clicking on the Sportswear And Accessories tab from the New Arrivals Section works correctly ", priority = 35)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "3. Medium Severity"}, description = "HomePage- Make sure that previous and next button in the New Arrivals Section works correctly", priority = 36)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "3. Medium Severity"}, description = "HomePage- Make sure the Got A Question section is displayed ", priority = 37)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "All Smoke Testing Result", "1. Critical Severity"}, description = "HomePage- Make sure the clicking on email button from the Got A Question section works correctly ", priority = 38)
...
//        homePage.navigateToHomePage();
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the Sports Supplements category from the HomePage works correctly ", priority = 39)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the Healthy Food category from the HomePage works correctly ", priority = 40)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the Vitamins And Health category from the HomePage works correctly ", priority = 41)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the Sportswear & Accessories category from the HomePage works correctly ", priority = 42)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the products appearing in the Top Selling Stacks section works correctly", priority = 43)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the products appearing in the Top Sellers section works correctly", priority = 44)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure clicking on the products appearing in the New Arrivals section works correctly", priority = 45)
    ...
    @Test(groups = {"Home Page", "1. Critical Severity"}, description = "HomePage- Make sure ability to access all pages inside the Top Selling Stacks category correctly ", priority = 46)
    ...
    @Test(groups = {"Home Page", "2. High Severity"}, description = "HomePage- Make sure clicking on phone button from the Got A Question section works correctly ", priority = 47)
