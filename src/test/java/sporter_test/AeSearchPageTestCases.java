...
//    }
//
//    @Test(groups = {"Search","All Smoke Testing Result","1.1 Critical Severity"},description = "Verify clicking on the search button will redirect the user to the search screen", priority = 1)
...
//    }
//    @Test(groups = {"Search", "1.1 Critical Severity"},description = "Make sure all search tabs(All, Products, Articles, Brands) tabs appearing correctly in the search screen", priority = 2)
...
//    }
//    @Test(groups = {"Search", "1.4 Low Severity"},description = "Search Page-Make sure the page bottom that appears in the footer section displays all 3 blocks:100% Secure Payments+ 100% Authentic Products+Fast Delivery Service blocks in the Search Page", priority = 3)
...
//    @Test(groups = {"Search","All Smoke Testing Result","1.3 Medium Severity"},description = "Search Page- Make sure all menus appearing in the Mega Menu are displayed correctly when hovering on them from Search page", priority = 4)
...
//    }
//    //All Tab
//    @Test(groups = {"Search", "1.1 Critical Severity"},description = "Search Page- Make sure clicking on the All tab will redirect the user to the correct page", priority = 5)
...
//    @Test(groups = {"Search","All Smoke Testing Result","1.2 High Severity"},description = "Search Page- Make sure the ability to access all products appearing below the products section in the All Page", priority = 6)
...
//
//
//    @Test(groups = {"Search", "1.1 Critical Severity"},description = "Search Page- Make sure the ability to access all brands appearing in the Brands Page", priority = 7)
...
//        }
//    }
//    @Test(groups = {"Search", "1.3 Medium Severity"},description = "Search Page- Make sure the the number of Brands Result retrieve a correct number", priority = 8)
...
//    }
//    @Test(groups = {"Search", "1.1 Critical Severity"},description = "Search Page- Make sure the ability to access all brands appearing below the Brands section in the All Page", priority = 9)
...
//    }
//// Search Result
//    @Test(groups = {"Search", "1.3 Medium Severity"},description = "Search Page- Make sure the search result matched with what the user search for", priority = 10)
