...
//        QatarProductDetailsPage qatarProductDetailsPage = new QatarProductDetailsPage(webDriver);
//        qatarProductDetailsPage.displayTheProduct();
//        DataHelperAndWait.hoverOnElement(qatarProductDetailsPage.getShopByMenu(),webDriver);
...
//        QatarProductDetailsPage qatarProductDetailsPage = new QatarProductDetailsPage(webDriver);
//        qatarProductDetailsPage.displayTheProduct();
//        DataHelperAndWait.hoverOnElement(qatarProductDetailsPage.getSportsSupplementsMenu(),webDriver);
